...
local DEFAULTS = {
    profile = {
        ...
        -- Per-module (spec)
        modules = {
            windfuryBubbles = moduleDefaults(true, 1.0, 1.0),
            shieldIndicator = moduleDefaults(true, 0.2, 1.0),
            shamanisticFocus = moduleDefaults(true, 0.8, 1.0),
            totemBar = moduleDefaults(true, 1.0, 1.0),
            weaponImbueBar = moduleDefaults(true, 0.4, 1.0),
        },
        ...
        wfCenterSize = nil,
        wfCenterTextTitleY = nil,
        wfCenterTextTotalY = nil,
        wfCenterTextCriticalY = nil,
        wfTotemBarScale = 1.0,
        wfRadialShown = false,
        ...
        focusFrame = {
            ...
            x = 0, y = -150, scale = 0.8, locked = false,
        },
    },
}
